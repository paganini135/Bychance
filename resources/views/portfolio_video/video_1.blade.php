...
<div class="content">
    ...
    <div class="inner_wrap container">
        <div class="about_box">
            ...
            <img src="/imgs/portfolio/video/video__001.png" alt="" class="">
            <p class="port_detail_text mt-10">WeddingView 영상 편집 디자인</p>
        ...
        <iframe width="624" height="350" src="https://www.youtube.com/embed/46J89XUbryI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>    
