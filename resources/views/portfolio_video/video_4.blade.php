...
<div class="content">
    ...
    <div class="inner_wrap container">
        <div class="about_box">
            ...
            <p class="port_detail_text mt-10">웨딩뷰 소개 영상 편집 디자인</p>
        ...
        <iframe width="624" height="350" src="https://www.youtube.com/embed/dMS2A6Z8E4M" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>    
