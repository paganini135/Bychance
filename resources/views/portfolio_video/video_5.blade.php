...
<div class="content">
    ...
    <div class="inner_wrap container">
        <div class="about_box">
            ...
            <img src="/imgs/portfolio/video/video__004.png" alt="" class="">
            <p class="port_detail_text mt-10">비비엔다 스튜디오 소개 영상 편집 디자인</p>
        ...
        <iframe width="560" height="315" src="https://www.youtube.com/embed/VOTIceqh6Y8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>    
