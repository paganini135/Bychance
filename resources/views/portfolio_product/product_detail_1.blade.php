...
<div class="content">
    ...
    <div class="inner_wrap container">
        <div class="about_box">
            ...
            <img src="/imgs/portfolio/product/product_1.png" alt="" class="">
            <p class="port_detail_text mt-10">담쏙 상세페이지 편집 디자인</p>
            <p class="port_detail_text">정리된 레이아웃으로 전문적인 정보를 가독성 있게 읽어나갈 수 있도록 의도하였습니다.</p>           
            </div>
        <div class="d_port_img_wrap">
            <img src="/imgs/portfolio/product/d_product_1.jpg" class="d_port_img">
        </div>
        </div>
    </div>
